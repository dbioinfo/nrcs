...
This repository contains a data wrangling pipeline for the Pietrasiask lab with several subroutines. 

### PLFA Wranglin

This subroutine organizes the constant stream of data being generated by the PLFA arm of this project. As results come in, this routine integrates the data into an existing consistent database and updates a report with the new data included.

This subroutine takes 2 main inputs: `MetaData_PLFA_MM.xlsx` and a directory of csv files `PLFAData`
